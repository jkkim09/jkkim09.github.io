            ...
            <section className='projectInfo'>
                <div>
                    ...
                    <div className='mySelf'>
                        안녕하십니까 개발자 김자경 입니다. 저는 직업을 개발자로 정했을 때 "꾸준하게 공부하고 발전하겠다"는 저 자신과의 약속을 하였습니다. 이전{myYear() - 1}년을 돌아보면
                        자신과의 약속을 잘 지키고 있다고 생각합니다. 이처럼 앞으로도 지속적으로 자신과의 약속을 확인하며 발전해가는 개발자가 되도록 하겠습니다.
                    </div>
                </div>
                <div>
                    ...
                    <div className='history'>
                        {
                            ...
                            <div className='history-item' key={index}>
                                <span className='history-left'>{item.date.start}<br/>~<br/>{item.date.end}</span>
                                ...
                                <div className='historyEcp-right'>
                                    {item.skills &&
                                        <div className='historyEcp-skills'>
                                            {
                                                item.skills.map((i, j) => <span key={j}>{i}</span>)
                                            }
                                        </div>
                                    }
