...
const Experience = () => {
  ...
  return (
    <div className={classNames([SkillsStyle.skills__2])}>
              ...
              <td>
                ...
                >
                  <SwiperSlide>
                    <div className={ExStyle.itemArea__2}>
                      ...
                      <ul className={classNames([ExStyle.ul__area])}>
                        ...
                        <li>- 서비스 각 페이지 개발</li>
                        <li>
                          - AI(DAVIS) 시스템 Front-End 전체적인 페이지 개발
                        </li>
                      </ul>
                    </div>
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <div className={ExStyle.itemArea__1}>
                      <div className={classNames([ExStyle.low__title])}>
                        운동 관련 서비스 Front-End, BackOffice
                      </div>
                      <div className={classNames([ExStyle.low__title__info])}>
                  ...
                  <SwiperSlide>
                    <div className={ExStyle.itemArea__2}>
                      <div className={classNames([ExStyle.low__title])}>
                        ONLINE VIDEO PLATFROM HTML5 PLAYER, VIDEO GATEWAY
                        SERVICE
                      </div>
                      <div className={classNames([ExStyle.low__title__info])}>
                        HTML Video Player 개발, Video GW 개발(back-end)
                      </div>
                      <div className={classNames([ExStyle.item__list__area])}>
                        <div>PHP(CI)</div>
                        <div>WebPack</div>
                      ...
                      <ul className={classNames([ExStyle.ul__area])}>
                        <li>
                          - PHP를 이용하여 VOD 컨텐츠정보 및 기타 옵션 정보를
                          조회하여 Player에 전달하는 VG(Video Gateway)기능
                          개발및 유지보수
                        </li>
                        <li>
                          - VG에서 보낸 정보를 바탕으로 영상을 Play하는 HTML5
                          Player기능 개발및 유지보수
                        </li>
                  ...
                  <SwiperSlide>
                    <div className={ExStyle.itemArea__1}>
                      <div className={classNames([ExStyle.low__title])}>
                        SHOPPINGNT POINT ORDER PAGE
                      </div>
                      <div className={classNames([ExStyle.low__title__info])}>
                        쇼핑엔티 POINT 상품 주문 시스템 Front-End, Back-End 개발
                      </div>
                      <div className={classNames([ExStyle.item__list__area])}>
                        <div>Java(Spring)</div>
                        <div>Mysql</div>
                      ...
                      <ul className={classNames([ExStyle.ul__area])}>
                        <li>
                          모든 카드사의 포인트를 TVHUB포인트로 SHOPPINGNT 상품을
                          옵셕 수량 등 선택 및 결제 Front-End Page 신규 개발
                        </li>
                        <li>
                          Mobile 환경에 맞게 UI 개발및 크로스 브라우징대응
                        </li>
                        <li>기타 기능 개발 및 유지보수</li>
                        <li>
                          유지보수 및 성능을 고료하여 VueJs를 이용하여 Page개발
                        </li>
                  ...
                  <SwiperSlide>
                    <div className={ExStyle.itemArea__2}>
                      <div className={classNames([ExStyle.low__title])}>
                        TVHUB CARD POINT CONVERSION PAGE
                      </div>
                      <div className={classNames([ExStyle.low__title__info])}>
                        카드포인트를 tvhub 포인트로 통합해주는 페이지 기능 및
                        유지 Front-End, Back-End 개발
                      </div>
                      <div className={classNames([ExStyle.item__list__area])}>
                        <div>Java(Spring)</div>
                        <div>Mysql</div>
                      ...
                      <ul className={classNames([ExStyle.ul__area])}>
                        <li>
                          모든 카드사의 포인트를 TVHUB포인트로 전환하여 사용 할
                          수있게 해주는 Front-End Page 개발
                        </li>
                        <li>
                          Mobile 환경에 맞게 UI 개발및 크로스 브라우징대응
                        </li>
                  ...
                  <SwiperSlide>
                    <div className={ExStyle.itemArea__1}>
                      <div className={classNames([ExStyle.low__title])}>
                        U+ VIDEO PORTAL POINT CONVERSION PAGE
                      </div>
                      <div className={classNames([ExStyle.low__title__info])}>
                        LG비디오 포탈 APP 포인트 전환 페이지 Front-End 개발
                      </div>
                      <div className={classNames([ExStyle.item__list__area])}>
                        <div>Java(Spring)</div>
                        <div>Mysql</div>
                      ...
                      <ul className={classNames([ExStyle.ul__area])}>
                        <li>
                          모든 카드사의 포인트를 TVHUB포인트로 전환하여 사용 할
                          수있게 해주는 U+ VIDEO PORTAL APP 전용페이지 Front-End
                          Page 신규 개발
                        </li>
                        <li>
                          Mobile 환경에 맞게 UI 개발및 크로스 브라우징대응
                  ...
                  <SwiperSlide>
                    <div className={ExStyle.itemArea__2}>
                      <div className={classNames([ExStyle.low__title])}>
                        KT OLLEH TV MOBILE POINT CONVERSION PAGE
                      </div>
                      <div className={classNames([ExStyle.low__title__info])}>
                        올레티비 모바일 APP 포인트 전환 페이지 Front-End 개발
                      </div>
                      <div className={classNames([ExStyle.item__list__area])}>
                        <div>Java(Spring)</div>
                        <div>Mysql</div>
                      ...
                      <ul className={classNames([ExStyle.ul__area])}>
                        <li>
                          모든 카드사의 포인트를 TVHUB포인트로 전환하여 사용 할
                          수있게 해주는 KT OLLEH TV MOBILE APP 전용페이지
                          Front-End Page 신규 개발
                        </li>
                        <li>
                          Mobile 환경에 맞게 UI 개발및 크로스 브라우징대응
                        </li>
      ...
      <div className={MainStyle.main__bottom}></div>
    </div>
  );
};
