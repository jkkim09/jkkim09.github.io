...
const Skills = () => {
  return (
    <div className={classNames([SkillsStyle.skills])}>
        ...
        <div className={MainStyle.main__header__1}>
          <div
            className={classNames([
              ...
              MainStyle.main__header__line__2,
            ])}
          ></div>
      ...
      <div
        className={classNames([MainStyle.main__body, SkillsStyle.skills__back])}
      >
                ...
                <tr>
                  <td>
                    <div className={SkillsStyle.skills__info__area}>
                      <div
                        className={classNames([
                          SkillsStyle.skills__info,
                          SkillsStyle.skills__low__title,
                        ])}
                      >
                        #BACK-END
                      </div>
                      <div className={classNames([SkillsStyle.skills__info])}>
                        - Spring Boot
                      </div>
                      <div
                        className={classNames([
